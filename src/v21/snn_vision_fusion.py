...
class DualStreamVisionCortex:
    ...
    def __call__(self, state: FusionState, ev_frame, tof_dist, learn=True):
        ...
        new_stdp_state, stdp_spikes, _ = self.stdp(state.stdp_state, new_time_surface, tof_dist, learn=learn)
        ...
        # =================================================================
        new_stdp_trace_clean = jnp.where(new_stdp_trace < 0.05, 0.0, new_stdp_trace)
