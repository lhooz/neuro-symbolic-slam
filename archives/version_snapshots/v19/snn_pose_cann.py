...
class PoseCANN:
    ...
    def __call__(self, kin_t):
        ...
        # 🌟 THE UPGRADE: 2nd-Order Midpoint Integration (RK2)
        # Project the heading halfway into the future using the current angular velocity
        theta_mid = theta_current + (omega * DT) / 2.0
        
        # 2. Calculate the rotation matrices using the MIDPOINT heading
