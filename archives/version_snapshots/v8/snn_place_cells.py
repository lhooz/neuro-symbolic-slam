...
HOPFIELD_BETA         = 2.5    # Modern Hopfield exponential sharpening (Inverse Temperature)
...
TOFPOP_ANTI_ALIAS_POS = 0.60   # top-16 concentration threshold for anti-aliasing
TOFPOP_ANTI_ALIAS_HEA = 0.60   # top-4 concentration threshold for anti-aliasing
...
MATCH_TOF             = 0.60   # TOF match threshold 
